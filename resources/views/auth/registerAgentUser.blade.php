    ...
    <div class="flex justify-center min-h-screen">
        ...
        <div class="flex items-center w-full max-w-2xl p-2 mx-auto lg:px-12 lg:w-3/5">
            <div class="w-full">
                <div class="flex items-center justify-between">
                    <div class="mt-1">
                        ...
                        <div class="mt-3 md:flex md:items-center md:-mx-2">
                            <button id="clientLink" href="{{ route('register.externalUser') }}" class="flex justify-center w-full px-6 py-3 mt-4 text-black border border-black rounded-lg md:mt-0 md:w-auto md:mx-2 dark:border-black dark:text-black focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span class="mx-2">Cliente</span>
                            </button>
                            <button id="workerLink" href="{{ route('register.agentUser') }}" class="flex justify-center w-full px-6 py-3 text-white bg-black rounded-lg md:w-auto md:mx-2 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" enctype="multipart/form-data" action="" method="POST">
                    @csrf
                    <div>
                    ...
                    <div>
                        <label class="block mb-2 font-bold text-sm text-gray-600 dark:text-gray-600">Job Title</label>
                        <input name="Puesto" placeholder="Job Title" class="text-black placeholder-gray-600 w-full px-5 py-3 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-300 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                    </div>

                    <div>
                        <label class="block mb-2 font-bold text-sm text-gray-600 dark:text-gray-600">Salary</label>
                        <input name="Sueldo" placeholder="Salary" class="text-black placeholder-gray-600 w-full px-5 py-3 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-300 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                    </div>

                    <div class="md:col-span-2">
                        <label class="block mb-2 font-bold text-sm text-gray-600 dark:text-gray-600">Company</label>
                        <input name="Dependencia" placeholder="Company" class="text-black placeholder-gray-600 w-full px-5 py-3 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-300 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                    </div>

                    <button type="submit" class="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-black rounded-lg hover:bg-gray-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                        <span>Sign Up</span>
